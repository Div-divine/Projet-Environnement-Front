                    ...
                    <table className="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" className="text-center border-0"><p className="table-header-text">Email</p></th>
                        ...
                        <tbody className="table-container">
                            {filteredUserGroups.map(user => (
                                <tr key={user.user.user_id}>
                                    ...
                                    <td className="text-center"><p className="table-names-text">{user.user.user_email}</p></td>
                                    <td className="text-center">
